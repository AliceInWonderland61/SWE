...
Deploy to Render
----------------
Render is a cloud platform-as-a-service (PaaS) where we can deploy our Sinatra (and later Rails) applications. If you don't have an account yet, go sign up at [https://www.render.com/](https://www.render.com/). You will need to connect your GitHub account with Render. 

Go to [https://dashboard.render.com/](https://dashboard.render.com/) and create a new Web service ![image](https://user-images.githubusercontent.com/7307397/216992973-3c1e9cf5-d5ea-44d9-ade4-729f8ad5c013.png)

In the next page, select the repo you wish to deploy from the list. (If repos do not appear, copy and paste the web URL to your repo in the "Public Git Repository" section, not the .git URL)

If the repo was found you'll get a page with a form to get your website information:

1. Name: Please name your website the exact same as your repo.
2. Region: Does not really matter, but you need to choose one and remember your choice. (I choose Ohio (US EAST) because it is the closest).
3. Branch: Keep it as master. (You can create other web services with the same repo, but deploy different branches to show your customers).
4. Root Directory: Leave blank.
5. Evrionment: Ruby
6. Build Command: bundle install
7. Start Command: bundle exec rackup config.ru -p $PORT
8. Instance Type: Free
9. Advanced: Leave default 

After you create the Web Service the app will immediately start to deploy, on a successful deploy you will be able to go to the name you gave your website plus ```.onrender.com```

If you are able to see your website and interact with it, congratulations you are done deploying. Every subsequent commit to the repo will automatically deploy your changes (unless you unselect that option in Settings)
